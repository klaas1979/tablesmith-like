...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { GroupFunction: peg$parseGroupFunction };
  var peg$startRuleFunction = peg$parseGroupFunction;
  ...
  var peg$e4 = peg$classExpectation([['a', 'z'], ['0', '9'], ' ', '_'], false, true);
  ...
  var peg$f0 = function (table, group) {
    if (options == undefined) throw 'Could not parse Call no options provided!';
    options.table = table;
    options.group = group;
  };
  var peg$f1 = function (modType, modifier) {
    if (options == undefined) throw 'Could not parse Call no options provided!';
  ...
  function peg$parseGroupFunction() {
